...
local common = module.load("CassiopeiabyKornis", "common")
...
menu.misc:slider("lasthittimer", "Last Hit E Delay", 70, 10, 300, 1)
menu.misc.lasthittimer:set("tooltip", "Lower - Casts later, Higher - Casts earlier // Default is 70")
...
local function OnTick()
	...
	if orb.combat.is_active() and mana < 100 then
		orb.core.set_pause_attack(0)
	end

	if menu.keys.lastkey:get() and mana < 100 then
		orb.core.set_pause_attack(0)
	end
