...
--crypt.enc_f("C:/Users/Meow/Desktop/release/lol-nd/scripts/Kalista by Kornis/main.lua", "C:/Users/Meow/Desktop/main.lua")
local common = {}
...
function common.CheckBuffSoul()
  local MyLoveSoul = player
  ...
  for z, ally in ipairs(allies) do
    if ally then
      for i = 0, ally.buffManager.count - 1 do
        ...
        if
          buff and buff.valid and (buff.name == "kalistavobindally" or buff.name == "kalistacoopstrikeally") and
            buff.owner ~= player
         then
          MyLoveSoul = ally
        end
