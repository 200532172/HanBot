...
--crypt.enc_f("C:/Users/Meow/Desktop/release/lol-nd/scripts/Mordekaiser by Kornis/main.lua", "C:/Users/Meow/Desktop/main.lua")
...
function common.CheckBuff2(obj, buffname)
  if obj then
    for i = 0, obj.buffManager.count - 1 do
      ...
      if buff and buff.valid and buff.name:find(buffname) and buff.stacks > 0 then
        return true
      end
    end
  end
...
function common.CheckBuffType(obj, bufftype)
  if obj then
    for i = 0, obj.buffManager.count - 1 do
      local buff = obj.buffManager:get(i)
      if buff and buff.valid and buff.type == buffname then
        return true
      end
    end
  end
